...
class Molecule:
    ...
    def get_strand_ends(self, arg0: int, arg1: bool) -> list[Atom]:
        """
...
class SimplifiedBalanceNetwork:
    ...
    @property
    def nr_of_cross_links(self) -> int:
        ...
...
class Universe:
    ...
    def get_atoms_connected_to(self, vertex_idx: int) -> list[Atom]:
        """
                    Get the atoms connected to a specified vertex id.
        """
    ...
    def get_connected_atoms(self, atom: Atom) -> list[Atom]:
        """
                    Get the atoms connected to a specified atom.
