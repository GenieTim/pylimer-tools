...
class UnitStyle(object):
    ...
    def get_base_unit_of(self, property: str):
        ...
        .. code:: python
          ...
          siMass = ljMass * units.get_base_unit_of("mass")
        """
        translator = {
    ...
    def get_unit_style(self, unit_type: str,
        ...
        if (unit_type == "lj"):
            ...
            raise NotImplementedError(
                "Unity type '{}' is not implemented".format(unit_type))
