...
class MEHPForceBalance:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def construct_with_random_sliplinks(universe: Universe, nr_of_sliplinks_to_sample: int, upper_sampling_cutoff: float = 1.2, lower_sampling_cutoff: float = 0.0, minimum_nr_of_sliplinks: int = 0, same_strand_cutoff: float = 3, seed: str = '', crosslinker_type: int = 2, is_2d: bool = False) -> MEHPForceBalance:
        """
    ...
    def get_displacements(self) -> numpy.ndarray:
        ...
        """
    def get_effective_functionality_of_atoms(self, tolerance: float = 0.05) -> dict[int, int]:
        """
    ...
    def get_gamma_factors(self, b02: float) -> numpy.ndarray:
        ...
        """
    def get_ids_of_active_nodes(self, tolerance: float = 0.05, minimum_nr_of_active_connections: int = 2, maximum_nr_of_active_connections: int = -1, use_partial: bool = False) -> list[int]:
        """
    ...
    def get_neighbour_link_indices(self, network: SimplifiedBalanceNetwork, link_idx: int) -> list[int]:
        ...
    def get_nr_of_active_nodes(self, tolerance: float = 0.05, minimumNrOfActiveConnections: int = 2, maximumNrOfActiveConnections: int = -1, usePartial: bool = False) -> int:
        """
...
class MEHPForceRelaxation:
    ...
    def get_gamma_factors(self, b0_squared: float = -1.0) -> numpy.ndarray:
        ...
        """
    def get_ids_of_active_nodes(self, tolerance: float = 0.05, minimum_nr_of_active_connections: int = 2, maximum_nr_of_active_connections: int = -1) -> list[int]:
        """
                  Get the atom ids of the nodes that are considered active.
                  ...
                  :param maximumNrOfActiveConnections:  A node is active if it has equal or less than this number of active springs.
                       Use a value < 0 to indicate that there is no maximum number of active connections.
        """
    def get_nr_of_active_nodes(self, tolerance: float = 0.05, minimum_nr_of_active_connections: int = 2, maximum_nr_of_active_connections: int = -1) -> int:
        """
                   Get the number of active nodes remaining after running the simulation.
...
def predict_gelation_point(arg0: float, arg1: int, arg2: int) -> float:
    ...
    """
def randomly_sample_entanglements(universe: Universe, nr_of_samples: int, upper_cutoff: float, lower_cutoff: float = 0, minimum_nr_of_samples: int = 0, same_strand_cutoff: float = 3.0, seed: str = '', crosslinker_type: int = 2, ignore_crosslinks: bool = True) -> AtomPairEntanglements:
    """
