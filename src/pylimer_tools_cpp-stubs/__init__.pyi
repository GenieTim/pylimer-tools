...
class MEHPForceBalance:
    ...
    def construct_with_random_sliplinks(universe: Universe, nr_of_sliplinks_to_sample: int, acceptable_cutoff: float = 1.2, minimum_nr_of_sliplinks: int = 0,
                                        same_strand_cutoff: float = 3, seed: str = '', crosslinker_type: int = 2, is_2d: bool = False) -> MEHPForceBalance:
        """
...
def do_linear_walk_chain_from_to(box: Box, from_coordinates: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(
        3)], to_coordinates: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)], chain_len: int) -> dict[str, list[float]]:
    """
...
def randomly_sample_entanglements(universe: Universe, nr_of_samples: int, cutoff: float, minimum_nr_of_samples: int = 0,
                                  same_strand_cutoff: float = 3, seed: str = '', crosslinker_type: int = 2) -> AtomPairEntanglements:
    """
