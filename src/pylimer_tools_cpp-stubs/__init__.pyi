...
class MCUniverseGenerator:
    ...
    def __init__(self, lx: float, ly: float, lz: float) -> None:
        ...
    def add_and_link_strands_to_conversion(self, nr_of_strands: int, strand_lengths: list[int], crosslinker_conversion: float, strand_atom_type: int = 1, c_infinity: float = 1.0) -> None:
        """
        ...
        """
    def add_and_link_strands_to_soluble_fraction(self, nr_of_strands: int, strand_lengths: list[int], soluble_fraction: float, strand_atom_type: int = 1, c_infinity: float = 1.0) -> None:
        """
                    Actually add strands, link them to the previously added cross-linkers.
    ...
    def config_step_output(self, output_configuration: list[OutputConfiguration]) -> None:
        """
                  ...
                  Arguments:
                       - values: a list of OutputConfiguration structs
        """
    def get_active_chains(self, tolerance: float = 0.01) -> list[Molecule]:
        """
...
def do_random_walk_chain_from_to(box: Box, from_coordinates: numpy.ndarray, to_coordinates: numpy.ndarray, chain_len: int, bead_distance: float = 1.0, mean_squared_bead_distance: float = 1.0, seed: str = '') -> numpy.ndarray:
    ...
    """
def do_random_walk_chain_from_to_mc(box: Box, from_coordinates: numpy.ndarray, to_coordinates: numpy.ndarray, chain_len: int, bead_distance: float = 1.0, mean_squared_bead_distance: float = 1.0, seed: str = '', n_iterations: int = 1000) -> numpy.ndarray:
    """
                Do a random walk from one point to another.
