...
class MEHPForceBalance:
    ...
    def __init__(self, universe: Universe, crosslinker_type: int = 2, is_2d: bool = False, kappa: float = 1.0,
                 remove_2functional_crosslinkers: bool = True, remove_dangling_chains: bool = False) -> None:
        """
