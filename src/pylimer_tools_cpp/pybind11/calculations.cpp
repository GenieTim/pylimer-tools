...
init_pylimer_bound_calc(py::module_& m)
{
  ...
  py::class_<mehp::MEHPForceBalance>(m, "MEHPForceBalance", R"pbdoc(
    ...
    //           simulation.
    //      )pbdoc")
    .def("getNumAtoms", &mehp::MEHPForceBalance::getNumAtoms)
  ...
  py::class_<mehp::MEHPForceBalance2>(m, "MEHPForceBalance2", R"pbdoc(
    ...
    .def("getNumAtoms", &mehp::MEHPForceBalance2::getNumAtoms)
    .def("getNumExtraAtoms", &mehp::MEHPForceBalance2::getNumExtraAtoms)
    .def("getNumBonds", &mehp::MEHPForceBalance2::getNumBonds)
  ...
  py::class_<dpd::DPDSimulator>(m,
    ...
    .def("getNumAtoms", &dpd::DPDSimulator::getNumAtoms)
    .def("getNumExtraAtoms", &dpd::DPDSimulator::getNumExtraAtoms)
    .def("getNumBonds", &dpd::DPDSimulator::getNumBonds)
