...
namespace calc {
  namespace dpd {
     ...
     *
     */
    void DPDSimulator::refreshCurrentState()
    {
      pylimer_tools::utils::PerformanceTimer timer =
        pylimer_tools::utils::PerformanceTimer<
          DPDPerformanceSections::NUM_PERFORMANCE_SECTIONS>();
     ...
     * @param seed
     */
    void DPDSimulator::reseedRandomness(const std::string& seed)
    {
     ...
     * the DPD steps"
     */
    void DPDSimulator::resetBondDuplicationPenalty()
    {
     ...
     *
     */
    void DPDSimulator::attemptBondFormation()
    {
      ...
      if (accept) {
        ...
        if (!((this->bondBoxOffsets.segment(3 * springIdx, 3) -
          ...
          std::cerr
            ...
            << this->bondBoxOffsets.segment(3 * springIdx, 3) << " instead of "
            << originalOffsets +
                 ((shiftEndAIsFirstOnRailBond ? 1. : -1.) *
                  this->bondBoxOffsets.segment(3 * selectedRailBondA, 3)) -
                 ((shiftEndBIsFirstOnRailBond ? 1. : -1.) *
