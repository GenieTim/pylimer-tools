...
public:
    ...
    double getL(const int i) const
    {
        return this->L[i % 3];
    }
    Eigen::Array3d getL() const
    {
        return this->L;
    }
    double getLowL(const int i) const
    {
        return this->loCoords[i % 3];
    }
    Eigen::Array3d getLowL() const
    {
        return this->loCoords;
    }
    double getHighL(const int i) const
    {
        return this->hiCoords[i % 3];
    }
    Eigen::Array3d getHighL() const
    {
        return this->hiCoords;
    }
    ...
    {
        return this->loCoords[0];
    }
    double getLowY() const
    {
        return this->loCoords[1];
    }
    double getLowZ() const
    {
        return this->loCoords[2];
    }

    double getHighX() const
    {
        return this->hiCoords[0];
    }
    double getHighY() const
    {
        return this->hiCoords[1];
    }
    double getHighZ() const
    {
        return this->hiCoords[2];
    }

    double getShearMagnitude() const
    {
        return this->simpleShearMagnitude;
    }
    int getShearDirection() const
    {
        return this->shearDirection;
    }
