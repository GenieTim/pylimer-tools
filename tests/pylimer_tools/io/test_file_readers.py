...
from pylimer_tools.io.extract_thermo_data import (
    detect_headers, extract_thermo_params, get_thermo_cache_name_suffix,
...
class TestFileReader(PandasComparingTestCase):
    ...
    def test_thermo_data_reader(self):
        thermo_file = os.path.join(os.path.dirname(
        ...
        os.remove(get_cache_file_name(
            thermo_file, get_thermo_cache_name_suffix(header)))
        # test: empty file
        empty_data = extract_thermo_params(os.path.join(
        ...
        self.assertListEqual(detected_headers, [
        ...
        self.assertListEqual(list(read_data4.columns),
                             list(read_data5.columns))
    ...
    def test_lammps_dump_reader(self):
        ...
        dump_file = os.path.join(os.path.dirname(
