...
class UniverseUsingTestCase(unittest.TestCase):
    ...
    *7-*6-5
    ...
    def setUp(self):
        ...
        self.testUniverseSmall.add_atoms(
            self.testAtomsSmall["id"],
            self.testAtomsSmall["type"],
            self.testAtomsSmall["x"],
            self.testAtomsSmall["y"],
            self.testAtomsSmall["z"],
            self.testAtomsSmall["nx"],
            self.testAtomsSmall["ny"],
            self.testAtomsSmall["nz"],
        )
        ...
        self.testAtomsSaturated = pd.concat(
            [
                self.testAtoms,
                pd.DataFrame(
                    [
        ...
        self.testBondsSaturated = pd.concat(
            [
                self.testBonds,
                pd.DataFrame(
                    [
    ...
    def addAtomBondData(
        self, universe: Universe, atomData: pd.DataFrame, bondData: pd.DataFrame
    ) -> Universe:
        universe.add_atoms(
            atomData["id"].tolist(),
            atomData["type"].tolist(),
            atomData["x"].tolist(),
            atomData["y"].tolist(),
            atomData["z"].tolist(),
            atomData["nx"].tolist(),
