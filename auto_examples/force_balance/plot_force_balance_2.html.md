...
<!-- "auto_examples/force_balance/plot_force_balance_2.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-force-balance-plot-force-balance-2-py"></a>
...
See Bernhard and Gusev [[BG25](../../acknowledgements.md#id12)]

<!-- GENERATED FROM PYTHON SOURCE LINES 9-66 -->
```none
Final residual (should be close to 0): 4.3405573056120786e-14
Shear Modulus [MPa]:  0.09934743685260185
```
...
<a id="sphx-glr-download-auto-examples-force-balance-plot-force-balance-2-py"></a>
