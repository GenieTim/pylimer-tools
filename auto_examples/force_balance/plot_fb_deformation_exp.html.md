...
<!-- "auto_examples/force_balance/plot_fb_deformation_exp.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-force-balance-plot-fb-deformation-exp-py"></a>
...
```none
Final residual (should be close to 0): 3.9101564830854116e-13
Shear Modulus from Equilibrium [MPa]:  0.10093227162064117
```
...
<a id="sphx-glr-download-auto-examples-force-balance-plot-fb-deformation-exp-py"></a>
