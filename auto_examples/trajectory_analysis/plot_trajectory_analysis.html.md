...
<!-- "auto_examples/trajectory_analysis/plot_trajectory_analysis.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-trajectory-analysis-plot-trajectory-analysis-py"></a>
...
Please beware that the MSD is computed in an $N^2$ manner, which can be slow for large systems,
...
**Total running time of the script:** (9 minutes 6.771 seconds)

<a id="sphx-glr-download-auto-examples-trajectory-analysis-plot-trajectory-analysis-py"></a>
