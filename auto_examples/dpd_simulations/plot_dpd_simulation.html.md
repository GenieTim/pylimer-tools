...
<!-- "auto_examples/dpd_simulations/plot_dpd_simulation.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-dpd-simulations-plot-dpd-simulation-py"></a>
...
References: Langeloth *et al.* [[LMBohmMullerPlathe13](../../acknowledgements.md#id11)] and Schneider *et al.* [[SFKarimiVarzanehMullerPlathe21](../../acknowledgements.md#id10)].
...
e.g., in the terminal before running your script: `export OMP_NUM_THREADS=4` to use 4 threads.
...
<a id="sphx-glr-download-auto-examples-dpd-simulations-plot-dpd-simulation-py"></a>
