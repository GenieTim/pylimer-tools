...
<!-- "auto_examples/structure_analysis/plot_structure_analysis.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-structure-analysis-plot-structure-analysis-py"></a>

# Extract Synthesis Parameters

This example demonstrates how to analyze the structure of a crosslinked polymer network
to get the stoichiometric imbalance $r$,
the crosslinker conversion $p$ or
the functionality of the crosslinker $f$.
...
<a id="sphx-glr-download-auto-examples-structure-analysis-plot-structure-analysis-py"></a>
