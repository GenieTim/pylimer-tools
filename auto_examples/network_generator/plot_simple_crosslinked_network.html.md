...
<!-- "auto_examples/network_generator/plot_simple_crosslinked_network.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-network-generator-plot-simple-crosslinked-network-py"></a>
...
```none
Generated network with 4100 atoms
```
...
<a id="sphx-glr-download-auto-examples-network-generator-plot-simple-crosslinked-network-py"></a>
