...
<!-- "auto_examples/network_generator/plot_vulcanized_network.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-network-generator-plot-vulcanized-network-py"></a>
...
Refer to [File I/O: Readers & Writers](../readers_writers/index.md#sphx-glr-auto-examples-readers-writers) for more details on how you can save the universe to a file.
...
**Total running time of the script:** (1 minutes 26.012 seconds)

<a id="sphx-glr-download-auto-examples-network-generator-plot-vulcanized-network-py"></a>
