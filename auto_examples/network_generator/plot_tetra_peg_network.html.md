...
<!-- "auto_examples/network_generator/plot_tetra_peg_network.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-network-generator-plot-tetra-peg-network-py"></a>

# Tetra-PEG Network Generation

This example demonstrates how to create a tetra-PEG (tetra-functional polyethylene glycol)
network using the [`add_star_crosslinkers()`](../../api/pylimer_tools_cpp.MCUniverseGenerator.md#pylimer_tools_cpp.MCUniverseGenerator.add_star_crosslinkers)
and [`link_strands_to_strands_to_conversion()`](../../api/pylimer_tools_cpp.MCUniverseGenerator.md#pylimer_tools_cpp.MCUniverseGenerator.link_strands_to_strands_to_conversion) methods.
...
The thumbnail was created using the [polymer-graph-sketcher](https://genietim.github.io/polymer-graph-sketcher/) tool.

<!-- GENERATED FROM PYTHON SOURCE LINES 15-165 -->
```none
Starting tetra-PEG network generation at 2026-05-02 16:50:13.936427
System parameters:
  Box size: 80.0³
  Star crosslinkers: 150
  Star functionality: 4
  Arm length: 20 beads
  Free chains: 50 of 15 beads
  Target strand-strand conversion: 0.9
Adding star crosslinkers with pre-attached arms...
Adding additional free polymer chains...
System before strand-strand linking:
  Total atoms: 12900
  Total bonds: 12700
Linking strand ends to achieve 90.0% conversion...
System after strand-strand linking:
  Total atoms: 12900
  Total bonds: 12985
  Final strand conversion: 0.822
Relaxing crosslink positions...
Generating final universe with bead coordinates...
Network generation completed at 2026-05-02 16:50:13.959452
Final network statistics:
  Total atoms: 12900
  Total bonds: 12985
  Box dimensions: 80.0 × 80.0 × 80.0
Network analysis:
  Star crosslinkers: 150
  Total star arms: 600
  Free chain ends (before linking): 700
  Free chain ends (after linking): 130
  Fully free chains (after linking): 0
Saving network structure...
Network saved to 'generated_structures/tetra_peg_network.data'
```
...
<a id="sphx-glr-download-auto-examples-network-generator-plot-tetra-peg-network-py"></a>
