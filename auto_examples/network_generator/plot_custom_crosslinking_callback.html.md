...
<!-- "auto_examples/network_generator/plot_custom_crosslinking_callback.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-network-generator-plot-custom-crosslinking-callback-py"></a>

# Custom Crosslinking with Callback Functions

This example demonstrates how to use the [`link_strands_callback()`](../../api/pylimer_tools_cpp.MCUniverseGenerator.md#pylimer_tools_cpp.MCUniverseGenerator.link_strands_callback)
method to create custom crosslinking procedures
as an alternative to the built-in linking methods,
[`link_strands_to_conversion()`](../../api/pylimer_tools_cpp.MCUniverseGenerator.md#pylimer_tools_cpp.MCUniverseGenerator.link_strands_to_conversion) and
[`link_strands_to_soluble_fraction()`](../../api/pylimer_tools_cpp.MCUniverseGenerator.md#pylimer_tools_cpp.MCUniverseGenerator.link_strands_to_soluble_fraction).
...
<!-- GENERATED FROM PYTHON SOURCE LINES 41-128 -->
```Python
...
<a id="sphx-glr-download-auto-examples-network-generator-plot-custom-crosslinking-callback-py"></a>
