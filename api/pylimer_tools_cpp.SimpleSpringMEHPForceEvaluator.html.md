...
### *class* pylimer_tools_cpp.SimpleSpringMEHPForceEvaluator(self: [pylimer_tools_cpp.SimpleSpringMEHPForceEvaluator](#pylimer_tools_cpp.SimpleSpringMEHPForceEvaluator), kappa: [SupportsFloat](https://docs.python.org/3/library/typing.html#typing.SupportsFloat) = 1.0)
...
| [`is_2d`](#pylimer_tools_cpp.SimpleSpringMEHPForceEvaluator.is_2d)     |    |
|------------------------------------------------------------------------|----|
| [`network`](#pylimer_tools_cpp.SimpleSpringMEHPForceEvaluator.network) |    |

### Methods Summary

| [`evaluate_force_set_gradient`](#pylimer_tools_cpp.SimpleSpringMEHPForceEvaluator.evaluate_force_set_gradient)(self, n, ...[, ...])   | Evaluate the force and optionally compute its gradient.   |
|---------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| [`evaluate_stress_contribution`](#pylimer_tools_cpp.SimpleSpringMEHPForceEvaluator.evaluate_stress_contribution)(self, ...)           | Evaluate the stress-contribution for a single spring.     |
| [`prepare_for_evaluations`](#pylimer_tools_cpp.SimpleSpringMEHPForceEvaluator.prepare_for_evaluations)(self)                          | Prepare the evaluator for a series of evaluations.        |
